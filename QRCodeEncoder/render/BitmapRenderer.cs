...
namespace ZXing.Rendering
{
   ...
   public class BitmapRenderer : IBarcodeRenderer<Bitmap>
   {
      ...
      /// <returns></returns>
      public Bitmap Render(BitMatrix matrix, string content)
      {
         return Render(matrix, content, null);
      }
      ...
      /// <returns></returns>
      virtual public Bitmap Render(BitMatrix matrix, string content, EncodingOptions options)
      {

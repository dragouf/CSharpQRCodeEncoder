...
namespace ZXing
{
   ...
   public class BarcodeWriterGeneric<TOutput> : IBarcodeWriterGeneric<TOutput>
   {
      ...
      /// </summary>
      public QrCode.QRCodeWriter Encoder { get; set; }
      ...
      {
         var encoder = Encoder ?? new QrCode.QRCodeWriter();
         var currentOptions = Options;
         return encoder.encode(contents, currentOptions.Width, currentOptions.Height, currentOptions.Hints);
      }
      ...
      public TOutput Write(string contents)
      {
         ...
         return Renderer.Render(matrix, contents, Options);
      }
      ...
      public TOutput Write(BitMatrix matrix)
      {
         ...
         return Renderer.Render(matrix, null, Options);
      }
   }
}
